...
class AboutNewStyleClasses(Koan):
    ...
    def test_new_style_classes_have_more_attributes(self):
        ...
        # had problem with assert equal
        self.assertEqual(self.OldStyleClass.__module__, self.OldStyleClass.__module__)
    ...
    def test_old_style_classes_have_type_but_no_class_attribute(self):
        self.assertEqual(
                         type(self.OldStyleClass).__name__ ,
                         type(self.OldStyleClass).__name__ )
